...
public class SponsorFragment extends Fragment implements DiscreteScrollView.OnItemChangedListener,
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        sponsorData = Arrays.asList(
                new Sponsor("WTM", "Sponsor", "https://www.womentechmakers.com/india",R.drawable.wtm_white),
                new Sponsor("LBRY", "Sponsor", "https://lbry.io/", R.drawable.ic_lbry),
                new Sponsor("Turbot", "Sponsor", "https://turbot.com/", R.drawable.ic_turbot),
                new Sponsor("UpCloud", "Sponsor", "https://upcloud.com/", R.drawable.ic_upcloud),
                new Sponsor("Hackerearth", "Sponsor", "https://www.hackerearth.com/", R.drawable.ic_hacker),
                new Sponsor("C9 Bistro", "Sponsor", "https://www.facebook.com/c9bistro/", R.drawable.bristo_white),
                new Sponsor("MSG91", "Sponsor", "https://msg91.com/", R.drawable.ic_msg));
